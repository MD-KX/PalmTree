...
# Calculating tropical distance of two points
...
# Calculating the sum of tropical distances of a bunch of trees
...
# Transfer the projected point vectors for plotting in 2-D.
...
# Normolize the transfered vectors.
...
# Calculating the distance matrix of the input tree data set. 
...
# Normalizing the ultrametric of a tree.
...
# Calculating R-square by calling lprec package. 
...
# Transfering the list of distance vectors to distance matrix.
